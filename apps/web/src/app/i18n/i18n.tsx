...
const dict: Record<Lang, Record<string, string>> = {
  de: {
    ...
    'login.openWorkspace': 'Test-Arbeitsbereich öffnen',
    'login.supabaseNote': 'Angemeldet über Supabase.',
    'login.devNote': 'Meldet sich als Supabase-Testkonto an.',
    ...
    'cat.subtitle': '2.869 Positionen · +30 % Aufschlag',
    ...
    'cat.basePrice': 'Einkaufspreis (€)',
    'cat.markup': 'Aufschlag %',
    'cat.sellPrice': 'Verkaufspreis',
    ...
    'cat.itemMeta': 'EK {base} · +{markup}% · pro {unit}',
  ...
  en: {
    ...
    'login.openWorkspace': 'Open test workspace',
    'login.supabaseNote': 'Signed in with Supabase.',
    'login.devNote': 'Signs in as the seeded Supabase test account.',
    ...
    'cat.subtitle': '2,869 items · +30% markup applied',
